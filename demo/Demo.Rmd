...
```{r}
dat <- read.table(Sys.glob("../../coverage/POG004/binned/1/*processed.bed")[1], stringsAsFactors = F, header = T)
str(dat)
devtools::load_all(pkg = "../")
result_2 <- ploidetect(dat, normal = 2, tumour = 1, avg_allele_freq = 4, window_id = 3, window_size = 5, GC = 6, verbose = F, CNA_call = F)
```
